    ...
    return (
        <main className="container flex-1 my-6 overflow-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>TwinCare Curated Insights</CardTitle>
                        <CardDescription>Based on your wearable device metrics, here are some insights to help you manage your chronic care condition.</CardDescription>
                    </CardHeader>
                    <CardContent>
