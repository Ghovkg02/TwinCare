...
export function ChatUI({ context, session, user }: { context: string, session: Session, user: any }) {
    ...
    useChat({
        ...
        initialInput: '',
        initialMessages: [
            { id: '1', role: 'system', content: `Hello ${session.user.name ?? "there"}! I\'m the Chronic Care assistant, loaded with over 25,000 chronic care articles, books, and organization blogs. Let me know how I can help you today!` },
        ],
    });
