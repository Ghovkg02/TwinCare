...
export default function DashboardPage() {
    ...
    const summaryText = `As of today's date, your hemoglobin levels are stable. Remember to stay hydrated and
            ...
            symptoms, please contact Dr. Ram, the hematologist we've pulled from your records on TwinCare.`;
    const heartRateData = [
        { time: "12am", rate: 65 },
        { time: "3am", rate: 60 },
        { time: "6am", rate: 62 },
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            <div className="rounded-lg shadow-md bg-purple-100 dark:bg-muted p-4">
                                <p>
                                    TwinCare makes it easier for you to monitor your chronic care.
                                </p>
                                <p>
