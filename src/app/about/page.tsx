...
export const metadata: Metadata = {
    metadataBase: new URL("https://sicklesee.vercel.app/"),
    title: "About — TwinCare",
    description: "Learn more about the creators of TwinCare and the features of the platform.",
    icons: [{ rel: "icon", url: "/favicon.ico" }],
    openGraph: {
        title: "About — TwinCare",
        description: "Learn more about the creator of TwinCare and the features of the platform.",
            ...
            <div className="container mx-auto px-4 md:mt-12 py-16 max-w-4xl font-light">
                <header className="mb-10 relative text-center">
                    ...
                    <h1 className="text-4xl font-bold mb-4">
                        <a href="https://tomnyuma.rocks" target="_blank" className="text-primary hover:underline">Ghovindh KG</a>
                    </h1>
                    <p className="text-xl text-muted-foreground font-normal">Creator of TwinCare</p>
                </header>
                <section className="mb-16">
                    <h2 className="text-2xl font-semibold mb-4 mx-4">About Me</h2>
                    <p className="text-lg text-muted-foreground mb-4">
                        Hey! I'm Bhumika, mostly known as Bhumi. I'm a student at Dr Ambedkar Institute Of Technology studying EEE and
                        ...
                        <br />
                        <br />
                        I created Chronic Care to help people just like me better understand their health and improve their quality of life. There's many things in this application
                ...
                <section className="mb-16">
                    <h2 className="text-2xl font-semibold mb-4 mx-4">TwinCare Features</h2>
                ...
                <section>
                    ...
                    <div className="flex space-x-4">
                        <Link href={"https://github.comyumat/sicklesense"} passHref target="_blank">
                            <Button variant="link" className="text-foreground">
                                <Github className="mr-2 h-4 w-4" />
                                GitHub
                            </Button>
                        </Link>
                        <Link href={"https://devpost.comoftware/sicklesense"} passHref target="_blank">
                            <Button variant="link" className="text-foreground">
                                Devpost
                            </Button>
                        </Link>
                        <Link href={"https://mnyuma.rocks"} passHref target="_blank">
                            <Button variant="link" className="text-foreground">
                                My Website
                            </Button>
                        </Link>
